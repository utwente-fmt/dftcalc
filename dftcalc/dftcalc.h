...
namespace DFT {
	...
	public:
		 ...
		 */
		int calculateDFT(const std::string& cwd, const File& dft, const std::vector<std::pair<std::string,std::string>>& timeSpec, unordered_map<string,string> settings,  bool calcImca);
